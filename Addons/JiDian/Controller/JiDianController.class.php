...
class JiDianController extends AddonsController{
    ...
    public function auto_verify(){
        ...
        $post="url=https://blog.niool.com/weixin/Verify/default.jpg&service=OcrKingForCaptcha&language=eng&charset=7&apiKey=7a035b90a8142c343eq9CThVaZK2nbB9kYb1LrOeCxqtH0wl7upz8Hk8pii90sXv6e1kd6qHQ9&type=http://niool.com/weixin/Verify/default.jpg";  
        curl_setopt($ch,CURLOPT_URL,"http://s.ocrking.net:9081/ok.html");
