<?php 
	...
	if($ret!=false){
		$url="https://blog.niool.com/weixin/index.php?s=/addon/QQCourseList/QQCourseList/course.html";
		header("location:$url");
	}else{
		$url="https://blog.niool.com/weixin/index.php?s=/addon/QQBind/QQBind/login.html";
		header("location:$url");
	}
