    ...
    <div class="row">
        <div class="panel panel-default" id="content">
            <div class="panel-body">
                <form class="form-horizontal" action="<?php echo U('index');?>" method="post">
                    <div class="form-group">
                        <label for="input1" class="col-xs-2 control-label">
                            <span class="glyphicon glyphicon-user"></span>
                        </label>
                        <div class="col-xs-10">
                            <input type="text" class="form-control" value="<?php echo $studentid?>" name="zjh" id="input1" placeholder="学号">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4" style="line-height: 30px;padding: 0px;">
                            <img src="<?php echo U('verify');?>" alt="点击获取" id="imgId" style="height: 27px;" onclick='this.src=<?php echo U("verify");?>?+Math.random()'>
                        </div>
                        <div class="col-xs-4" style="line-height: 30px;padding: 0px;">
                    ...
                    <input type="submit" class="btn btn-success" id="buttonId" name="submit" value="查成绩">
                </form>
            </div>
            <!-- 脚注 -->
