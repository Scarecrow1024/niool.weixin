...
<meta property="qc:admins" content="05562674477463757751016" />
<link rel="shortcut icon" href="<?php echo SITE_URL;?>/favicon.ico">
<title><?php echo empty($page_title) ? C('WEB_SITE_TITLE') : $page_title; ?></title>
<link href="/weixin/Public/static/font-awesome/css/font-awesome.min.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/weixin/Public/Home/css/base.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
...
<!--<![endif]-->
<script type="text/javascript" src="/weixin/Public/static/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/weixin/Public/static/uploadify/jquery.uploadify.min.js"></script>
<script type="text/javascript" src="/weixin/Public/Home/js/dialog.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/weixin/Public/Home/js/admin_common.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/weixin/Public/Home/js/admin_image.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript">
var  STATIC = "/weixin/Public/static";
var  ROOT = "/weixin";
</script>
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
       <a class="brand" title="<?php echo C('WEB_SITE_TITLE');?>" href="<?php echo U('index/index');?>"><img height="45" src="<?php if(C('SYSTEM_LOGO')) { echo C('SYSTEM_LOGO'); }else{ ?>/weixin/Public/Home/images/top_logo.png?v=<?php echo SITE_VERSION;?> <?php } ?>" title="<?php echo C('WEB_SITE_TITLE');?>"/></a>
                      ...
                      <?php switch($field["type"]): case "num": ?><input type="number" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo I($field[name], $field[value]);?>"><?php break;?>
                        ...
                        <?php case "picture": ?><div class="controls uploadrow" title="点击修改图片">
                            ...
                            <div class="upload-img-box">
                              <?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img width="120" height="120" src="/weixin<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
                            </div>
                          </div>
                          <script type="text/javascript">
								//上传图片
...
if(weixin_cover_picurl==undefined || weixin_cover_picurl==""){
	$('.weixin-cover-pic').attr('src',"/weixin/Public/Home/images/no_cover.png");
}else{
...
(function(){
  ...
  <script type="text/javascript" src="/weixin/Public/static/datetimepicker/js/bootstrap-datetimepicker.js"></script> 
